...
1. 10,000 in a test set (generally, 20-30% of all data),
2. 10,000 in a validation set (20-30% of the data left after the test set has been taken), and
3. the remaining 30,000 will be used to train the model (the training set).
